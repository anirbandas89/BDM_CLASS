...
struct background
{
  ...
  double fraction_fld; /**< fluid fraction of dark matter */                //modified by AD
  double redshift_fld; /**< Transition redshift of the fluid */
  double a_fld; /**< Scale factor during the transition of the fluid */
  double sharpness_fld; /**< Sharpness of the transition */
